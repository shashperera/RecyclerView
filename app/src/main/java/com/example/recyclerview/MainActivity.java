...
public class MainActivity extends AppCompatActivity {
    ...
    private void initRecyclerView(){
        ...
        //Instantiate our RecyclerView using the id resource that we created in our main activity’s XML layout file
        RecyclerView recyclerView = findViewById(R.id.recycler_view);

        RecyclerViewAdapter adapter = new RecyclerViewAdapter(mNames,mImageUrls,this);
        //attach our SimpleAdapter to the RecyclerView
        recyclerView.setAdapter(adapter);
        //Setting LayoutManager on your RecyclerView to display the data as a linear vertical list,
